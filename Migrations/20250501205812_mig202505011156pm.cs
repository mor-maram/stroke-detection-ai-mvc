...
{
    /// <inheritdoc />
    public partial class mig202505011156pm : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultIndex = table.Column<int>(type: "int", nullable: true),
                    ...
                    ConfidenceLevel = table.Column<decimal>(type: "decimal(10,6)", precision: 10, scale: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MedicalReports_Diagnosis_DiagnosisId",
                        column: x => x.DiagnosisId,
                        principalTable: "Diagnosis",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalReports_DiagnosisId",
